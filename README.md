 ...
 * [The Mathematical Mesh](https://tools.ietf.org/html/draft-hallambaker-mesh-architecture-01) is an IETF draft that specifies end-to-end secure infrastructure that facilitates the exchange of configuration and credential data between multiple user devices.
